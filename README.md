2. The use of the keyof keyword in TypeScript with an example: keyof এর মানে হলো "এর চাবিগুলো"। keyof দিয়ে আমরা কোনো অবজেক্ট টাইপের সব key কে ধরতে পারি। এটি TypeScript-এ type safety বাড়াতে সাহায্য করে এবং ভুল key ব্যবহারের সম্ভাবনা কমায়। যেমন একটি উদাহরণ হলো:
...
'keyof Book' এর key গুলো হলো: "title" | "author" | "pages"
...
3. The difference between any, unknown, and never types in TypeScript: এগুলো টাইপস্ক্রিপ্টের বিশেষ টাইপ হিসেবে ধরা হয়।

any (যেকোনো)
(ক) এটা টাইপস্ক্রিপ্টের চেকিং বন্ধ করে দেয়।  
(খ) আমরা একটা any ভেরিয়েবলে যা ইচ্ছা রাখতে পারি এবং সেটা দিয়ে যা ইচ্ছা করতে পারি।  
(গ) এটা ব্যবহার করলে ভুল হওয়ার সম্ভাবনা বেশি থাকে।
...
console.log(value + 5);  // error, unknown টাইপের মান সরাসরি ব্যবহার করা যাবে না
...
(গ) এটা এমন ফাংশনের জন্য ব্যবহার হয় যা কখনোই কোনো value return করে না।
